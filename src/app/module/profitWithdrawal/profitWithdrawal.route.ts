...
router.post("/", checkAuth(Role.owner, Role.manager), checkSubscription, requirePermission("Profit Withdrawal"), validateRequest(createProfitWithdrawalZodSchema), ProfitWithdrawalController.createProfitWithdrawal);
